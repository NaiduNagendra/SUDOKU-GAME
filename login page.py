...
def register():
    ...
    DOB_entry.pack()
    Label(register_screen,text="dd/mm/yyyy",bg="gray").pack()
...
def register_user():
    ...
    register_screen.geometry("350x400")
    Label(register_screen, text="Registration Success", fg="green", font=("calibri", 11)).pack()
    Button(register_screen, text="ok", width=10, height=1, command = login).pack()
...
def forgot():
    ...
    forgot_screen.geometry("300x250")
    username2_lable = Label(forgot_screen, text="Username * ")
    username2_lable.pack()
    username2_entry = Entry(forgot_screen,)
    username2_entry.pack()
    Button(forgot_screen, text="ok", width=10, height=1, command = forgot_verify).pack()
def forgot_verify():
    username1 = username_verify.get()
...
def main_account_screen():
    ...
    Label(text="Please Login To Your Account", bg="orange", width="450", height="3", font=("Arial Black", 13)).pack()
    Label(text="").pack()
    global username_verify
    global password_verify
    ...
    Label(main_screen, text="Username * ",bg="pink").pack()
    username_login_entry = Entry(main_screen, textvariable=username_verify)
    username_login_entry.pack()
    Label(main_screen, text="").pack()
    Label(main_screen, text="Password * ",bg="yellow").pack()
    password_login_entry = Entry(main_screen, textvariable=password_verify, show= '*')
    password_login_entry.pack()
    Label(main_screen, text="").pack()
    Button(main_screen, text="Login", width=10, height=1,bg="blue", command = login_verify).place(x='410',y='220')
    Button(main_screen, text="Register", width=10, height=1,bg="green", command = register).place(x='515',y='220')
    Button(main_screen, text="Forgot Password?", width=15, height=1,bg="orange",command=forgot).place(x='450',y='250')
